  ...
  return (
    <div className="space-y-2">
      {Array.from({ length: rows }).map((_, i) => (
        <div
          key={i}
          className="bg-[#141414] border border-[#1E1E1E] p-4 flex items-center justify-between"
        >
    ...
    <div className="bg-[#141414] border border-[#1E1E1E]">
      ...
      <div className="grid grid-cols-7">
        {Array.from({ length: 35 }).map((_, i) => (
          <div
            key={i}
            className="p-3 min-h-[80px] border-b border-r border-[#1E1E1E]"
          >
...
export function EmployeeListItemSkeleton(): React.ReactElement {
  return (
    <div className="bg-[#141414] border border-[#1E1E1E] p-4 flex items-center gap-4">
