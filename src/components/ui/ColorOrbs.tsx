  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className={`absolute top-[20%] left-[15%] -translate-x-1/4 -translate-y-1/4 ${s.teal} bg-[#8B6914] ${s.blur}`}
      ...
      <motion.div
        ...
        className={`absolute bottom-[15%] right-[10%] translate-x-1/4 translate-y-1/4 ${s.burgundy} bg-[#6B4A2A] ${s.blur}`}
        style={{ opacity: baseOpacity * 0.8 }}
      />
    </div>
  );
