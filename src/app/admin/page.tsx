    ...
    <div>
      ...
      <div className="relative mb-6">
        <input
          ...
          className="w-full bg-[#141414] border border-[#141414] px-4 py-3 text-sm outline-none focus:border-[#C9A84C]/40 transition-colors placeholder:text-[#6B6B6B]/40"
        />
        {searchQuery.length >= 2 && (
          <div className="absolute top-full left-0 right-0 z-10 bg-[#141414] border border-[#141414] border-t-0 max-h-[300px] overflow-y-auto">
            {searching ? (
              ...
              <Link key={b.id} href="/admin/bookinger" onClick={() => setSearchQuery("")}
                className="flex items-center justify-between p-3 hover:bg-[#1A1A1A] transition-colors border-b border-[#141414] last:border-0">
                <div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        {loading ? (
          ...
          <>
            <Link href="/admin/bookinger" className="bg-[#141414] border border-[#141414] p-5 hover:border-yellow-400/30 transition-colors">
            ...
            <Link href="/admin/bookinger" className="bg-[#141414] border border-[#141414] p-5 hover:border-blue-400/30 transition-colors">
            ...
            <Link href="/admin/meldinger" className="bg-[#141414] border border-[#141414] p-5 hover:border-[#C9A84C]/30 transition-colors">
            ...
            <Link href="/admin/ansatte" className="bg-[#141414] border border-[#141414] p-5 hover:border-[#C9A84C]/30 transition-colors">
            ...
            <div className="space-y-0">
              {upcomingBookings.map((b) => (
                <Link key={b.id} href={`/admin/bookinger`}
                  className="flex items-center justify-between py-3 border-b border-[#141414] last:border-0 hover:bg-[#1A1A1A] -mx-2 px-2 transition-colors">
                  <div>
                    <p className="text-sm">{b.customer_name}</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              {unreadMessages.map((m) => (
                <Link key={m.id} href="/admin/meldinger"
                  className="flex items-start gap-3 py-3 px-3 border border-[#141414] hover:border-[#C9A84C]/20 transition-colors">
