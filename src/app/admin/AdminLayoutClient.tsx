    ...
    <html lang="no">
      <body className={`font-sans antialiased transition-colors duration-300 ${lightMode ? "bg-[#F5F0E8] text-[#1A1A1A]" : "bg-[#0A0A0A] text-[#F5F0E8]"}`}>
        <div className="flex min-h-screen">
          {/* Mobile header */}
          <div className="fixed top-0 left-0 right-0 z-50 h-14 bg-[#111111] border-b border-[#141414] flex items-center justify-between px-4 lg:hidden">
          ...
          {/* Sidebar */}
          <aside className={`fixed top-0 left-0 bottom-0 w-64 border-r flex flex-col z-50 transition-all duration-300 ${sidebarOpen ? "translate-x-0" : "-translate-x-full"} lg:translate-x-0 ${lightMode ? "bg-white border-gray-200" : "bg-[#111111] border-[#141414]"}`}>
            {/* Logo */}
