  ...
  return (
    <div>
      ...
      <div className="flex gap-6">
        ...
        {/* Detail panel */}
        {selected && (
          <div className="w-1/2 bg-[#141414] border border-[#141414] p-6 sticky top-8 self-start">
            ...
            <div className="space-y-4 text-sm">
              ...
              <div className="border-t border-[#141414] pt-4">
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full bg-[#0A0A0A] border border-[#141414] px-3 py-2 text-sm text-[#F5F0E8] outline-none focus:border-[#C9A84C]/40 transition-colors resize-none"
