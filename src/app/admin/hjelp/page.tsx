...
export default function AdminHelpPage() {
  ...
  return (
    <div>
      ...
      <p className="text-[#6B6B6B] text-sm mb-8">Steg-for-steg guider for vanlige oppgaver</p>
      ...
      <div className="max-w-2xl space-y-0">
        {sections.map((section, i) => (
          <div key={i} className="border-b border-[#141414]">
            ...
            >
              <span className="text-sm font-medium group-hover:text-[#C9A84C] transition-colors">
                {section.title}
              </span>
