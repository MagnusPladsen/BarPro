    ...
    <html lang="no">
      <body className="bg-[#0A0A0A] text-[#F5F0E8] font-sans antialiased min-h-screen flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-lg">
          ...
          {done ? (
            <div className="border border-[#141414] bg-[#141414] p-10 text-center">
            ...
            <div className="border border-[#141414] bg-[#141414]">
              {/* Header */}
              <div className="p-8 border-b border-[#141414] text-center">
              ...
              {/* Price */}
              <div className="border-t border-[#141414] p-8 text-center bg-[#C9A84C]/[0.04]">
