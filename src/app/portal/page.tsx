    ...
    <div>
        ...
        {tabs.map((t) => (
          <button key={t.key} onClick={() => setTab(t.key)}
            className={`px-4 py-2 text-xs tracking-wider uppercase transition-colors cursor-pointer whitespace-nowrap ${
              tab === t.key ? "bg-[#C9A84C]/10 text-[#C9A84C] border border-[#C9A84C]/30" : "text-[#6B6B6B] border border-[#1E1E1E] hover:text-[#F5F0E8]"
            }`}>{t.label}</button>
        ))}
      </div>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-[#141414] border border-[#1E1E1E] p-6">
            ...
            {timeEntries.length === 0 ? (
              ...
              <div key={e.id} className="flex items-center justify-between py-2 border-b border-[#1E1E1E] last:border-0 text-sm">
                <div>
        ...
        <div>
          ...
          <div className="bg-[#141414] border border-[#1E1E1E]">
            ...
            <div className="grid grid-cols-7">
              {calDays.map((day, i) => {
                if (!day) return <div key={`e-${i}`} className="p-2 min-h-[70px] border-b border-r border-[#1E1E1E]" />;
      ...
      {tab === "timer" && (
        <div className="max-w-lg">
          <div className="bg-[#141414] border border-[#1E1E1E] p-6 space-y-5">
          ...
          {/* Recent entries */}
          <div className="mt-6 bg-[#141414] border border-[#1E1E1E] p-6">
